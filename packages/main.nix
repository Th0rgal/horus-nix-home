...
in
  {
    home.packages = with pkgs; [
      # MISC
      cachix appimage-run arandr haskellPackages.network-manager-tui barrier ffmpeg-full tmate hping ncat flashplayer-standalone
      # TERMINAL
      gotop htop neofetch cava zip unrar unzip xorg.xev escrotum tree gnupg
      aria2 imagemagick feh httpie
      # DEVELOPMENT
      idea.idea-ultimate postman elan nixfmt
